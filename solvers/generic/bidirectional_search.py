...
class SearchProcess:
    ...
    def expand_frontier(self, upper_bound_cost: float, other_process: 'SearchProcess'):
        """
        Discovers nodes
        """
...
class BidirectionalSearch:
    ...
    def search_tree(self):
        return self.forward_search.tree
    ...
    def solve(self):
        ...
        if self.backward_search.meeting_point and self.forward_search.meeting_point:
            ...
            self.backward_search.meeting_point.parent.parent = self.forward_search.meeting_point
