...
problem_heuristics: Dict[type[Problem], Set[type[Heuristic]]] = {
    ...
    NPuzzleProblem : {NPuzzleTilesOutOfPlaceHeuristic, NPuzzleEuclideanHeuristic, NPuzzleManhattanHeuristic},
...
avl_algos : Dict[str, type[Solver]] = { a.__name__.lower() : cast(type[Solver], a) for a in [DFSRecursive, DFSIter, BFS, Dijkstra, Greedy, AStar, IDAStar, IDDFS]}
